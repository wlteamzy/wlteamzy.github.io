...
class Test extends CI_Controller 
{
	...
	{
		$query = $this->db->query("SELECT DISTINCT TABLE_NAME
        FROM INFORMATION_SCHEMA.COLUMNS
        WHERE TABLE_SCHEMA = 'dev_prologin'");
        foreach($query->result() as $r) {
        	$this->db->query("ALTER TABLE ".$r->TABLE_NAME." CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci");
        }
        echo "done";
        exit();
