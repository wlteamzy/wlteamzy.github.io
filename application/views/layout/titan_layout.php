           ...
           ($this->user->info->admin || $this->user->info->admin_settings || $this->user->info->admin_members || $this->user->info->admin_payment)
              ...
              <li id="admin_sb">
                ...
                <div id="admin_sb_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['admin'])) echo "in" ?>">
                  <ul class="inner-sidebar-links">
                    ...
                    <li class="<?php if(isset($activeLink['admin']['menus'])) echo "active" ?>"><a href="<?php echo site_url("admin/menus") ?>"> <?php echo lang("ctn_437") ?></a></li>
                    <?php endif; ?>
                    <?php if($this->user->info->admin || $this->user->info->admin_members) : ?>
            ...
            <li id="content_sb">
                <a data-toggle="collapse" data-parent="#content_sb" href="#content_sb_c" class="collapsed <?php if(isset($activeLink['content'])) echo "active" ?>" >
                  <span class="glyphicon glyphicon-file sidebar-icon sidebar-icon-blue"></span> <?php echo lang("ctn_399") ?>
                  <span class="plus-sidebar"><span class="glyphicon <?php if(isset($activeLink['content'])) : ?>glyphicon-menu-down<?php else : ?>glyphicon-menu-right<?php endif; ?>"></span></span>
                </a>
                <div id="content_sb_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['content'])) echo "in" ?>">
                  ...
                  <?php if($this->common->has_permissions(array("admin", "content_manager", "content_worker"), $this->user)) : ?>
                   <li class="<?php if(isset($activeLink['content']['general'])) echo "active" ?>"><a href="<?php echo site_url("content") ?>"> <?php echo lang("ctn_438") ?></a></li>
                   <li class="<?php if(isset($activeLink['content']['categories'])) echo "active" ?>"><a href="<?php echo site_url("content/categories") ?>"> <?php echo lang("ctn_439") ?></a></li>
                 <?php endif; ?>
                   <li class="<?php if(isset($activeLink['content']['pages'])) echo "active" ?>"><a href="<?php echo site_url("page") ?>"> <?php echo lang("ctn_440") ?></a></li>
                   <li class="<?php if(isset($activeLink['content']['cats'])) echo "active" ?>"><a href="<?php echo site_url("page/categories") ?>"> <?php echo lang("ctn_441") ?></a></li>
