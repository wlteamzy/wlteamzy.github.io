    ...
    <div class="container-fluid">
      <div class="row">
              ...
              <li id="admin_sb">
                ...
                <div id="admin_sb_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['admin'])) echo "in" ?>">
                  <ul class="inner-sidebar-links">
                    ...
                    <li class="<?php if(isset($activeLink['admin']['menus'])) echo "active" ?>"><a href="<?php echo site_url("admin/menus") ?>"><span class="glyphicon glyphicon-arrow-right admin-sb-link"></span> <?php echo lang("ctn_437") ?></a></li>
                    <?php endif; ?>
                    <?php if($this->user->info->admin || $this->user->info->admin_members) : ?>
            ...
            <li id="content_sb">
                ...
                <div id="content_sb_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['content'])) echo "in" ?>">
                  ...
                  <?php if($this->common->has_permissions(array("admin", "content_manager", "content_worker"), $this->user)) : ?>
                   <li class="<?php if(isset($activeLink['content']['general'])) echo "active" ?>"><a href="<?php echo site_url("content") ?>"><span class="glyphicon glyphicon-arrow-right admin-sb-link"></span> <?php echo lang("ctn_438") ?></a></li>
                   <li class="<?php if(isset($activeLink['content']['categories'])) echo "active" ?>"><a href="<?php echo site_url("content/categories") ?>"><span class="glyphicon glyphicon-arrow-right admin-sb-link"></span> <?php echo lang("ctn_439") ?></a></li>
                 <?php endif; ?>
                   <li class="<?php if(isset($activeLink['content']['pages'])) echo "active" ?>"><a href="<?php echo site_url("page") ?>"><span class="glyphicon glyphicon-arrow-right admin-sb-link"></span> <?php echo lang("ctn_440") ?></a></li>
                   <li class="<?php if(isset($activeLink['content']['cats'])) echo "active" ?>"><a href="<?php echo site_url("page/categories") ?>"><span class="glyphicon glyphicon-arrow-right admin-sb-link"></span> <?php echo lang("ctn_441") ?></a></li>
        ...
        <div id="responsive-menu-links">
          ...
          <?php endif; ?>
          <?php if($this->common->has_permissions(array("admin", "content_manager", "content_worker"), $this->user)) : ?>
          <option value='<?php echo site_url("content") ?>'><?php echo lang("ctn_438") ?></option>
          <option value='<?php echo site_url("content/categories") ?>'><?php echo lang("ctn_439") ?></option>
        <?php endif; ?>
          <option value='<?php echo site_url("page") ?>'><?php echo lang("ctn_440") ?></option>
          <option value='<?php echo site_url("page/categories") ?>'><?php echo lang("ctn_441") ?></option>
