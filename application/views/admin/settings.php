...
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_457") ?></label>
    <div class="col-sm-10">
        <select name="logo_option" class="form-control">
        <option value="0"><?php echo lang("ctn_458") ?></option>
        <option value="1" <?php if($this->settings->info->logo_option == 1) echo "selected" ?>><?php echo lang("ctn_459") ?></option>
        </select>
        <span class="help-block"><?php echo lang("ctn_460") ?></span>
    </div>
</div>
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_453") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_455") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_456") ?></label>
    <div class="col-sm-10">
