...
<tr><td><img src="<?php echo base_url().$this->settings->info->upload_path_relative ?>/<?php echo $r->image ?>" class="page-image"></td><td><a href="<?php echo site_url("page/view/" . $r->ID) ?>"><?php echo $r->title ?></a></td><td><?php echo $r->summary ?></td><td><?php echo $this->common->get_user_display(array("username" => $r->username, "avatar" => $r->avatar, "online_timestamp" => $r->online_timestamp)) ?></td></tr>
<?php endforeach; ?>
</table>
</div>
