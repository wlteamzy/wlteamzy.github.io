	...
	public function __construct() 
	{
		...
		$site = $CI->db->select("site_name,site_desc,site_email,
			upload_path_relative, upload_path, site_logo, register,
			 ...
			 secure_login, comments, menu_highlight, stripe_secret_key,
			 stripe_publish_key, google_recaptcha, google_recaptcha_secret,
			 google_recaptcha_key, layout, logo_option")
		->where("ID", 1)
		->get("site_settings");
